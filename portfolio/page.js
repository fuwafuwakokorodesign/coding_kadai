document.addEventListener("DOMContentLoaded", () => {
    ...
    if (cloud1) {
        ...
        function onScroll() {
            ...
            const cloudTop1 = "80px";
            const cloudTop2 = "90px";
            const cloudTop3 = "80px";

            if (cloud1) {
                if (scrollY > messageTop - 300) {
            ...
            if (headerNav && logo && hamburgerEl) {
                if (
                    scrollY >= aboutBottom - 100 &&
                    scrollY < flowBottom - 100
                ) {
